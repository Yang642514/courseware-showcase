...
![课程课件展示页预览](lesson1-preview.png)

## 项目状态

- 定位：可复用的静态展示站模板
- 技术栈：Astro、Docker、Nginx、GitHub Actions、Sealos/Kubernetes
- 部署方式：推送代码后自动构建镜像并滚动更新
- 数据边界：只适合公开或已脱敏的静态内容，不提供访问控制
...
模板源代码与技术文档采用 [MIT License](LICENSE)。示例课件、课程文案、截图和配套素材不随模板代码自动授权再分发，具体范围见 [CONTENT_LICENSE.md](CONTENT_LICENSE.md)。
